export default {
    data: {
        ...
        vision: {
            title: "Vision",
            text: "Fittja Station and Square could be a light and bright space with lots of colour, with good seating arrangements protected from the weather that gives all types of people a reason to stay and hang out. It should be a place that has accessible public services, that is easy to find one’s way around, has people around to help me if I need, and has youth facilities that can cater to the needs of those who may otherwise end up hanging around."
        },
        possibilities: {
            title: "Possibilities",
