export default {
  data: {
    ...
    recipient:
      'Region Stockholm/SL (regional level) and Botkyrka municipality (local level)',

    observations: {
      title: 'Observations',
      text:
        'Today Fittja Station and Square is only a point of transit, dirty and characterised by noisy traffic, the maintenance off the place is inadequate, and the lightning is damaged or broken. It lacks activities that are free/where no consumption is needed, it is both unwelcoming and an unpleasant space to stay in and places in the area feels off-limits to girls. Today it is a high risk area as people run from the tube exit to the bus stops at the other side of the road.',
    },
    vision: {
      title: 'Vision',
      text:
        'Fittja Station and Square could be a light and bright space with lots of colour, with good seating arrangements protected from the weather that gives all types of people a reason to stay and hang out. It should be a place that has accessible public services, that is easy to find one’s way around, has people around to help me if I need, and has youth facilities that can cater to the needs of those who may otherwise end up hanging around.',
    },
    possibilities: {
      title: 'Possibilities',
      text:
        'Fittja Station and Square has the potential to provide even better and more accessible footpaths and public mobility, well working infrastructure, lighting and visibility, but also water and sanitation. It can be a space of flexibility, multi-purpose and multi-function, providing places for women, children, and elderly to loiter.',
    },
    priorities: {
      title: 'Design priorities',
      text:
        'Changes to the station, footpaths and public mobility, new entrance and exit, seating, relaxation areas, lighting, and green spaces. (parts of the proposals for the square such as the activity cubes and pink street could be implemented by these actors ie moved to the current bus stop if the bus station would be moved to the other side of the square - see first proposal.',
    },
    solution: {
      title: 'Main solution',
      text:
