export default {
    data: {
        ...
        responsibility: { title: "Responsibility", text: "Private sector" },
        partnership: {
            title: "Partnership",
            text: "Municipality, Private sector, Civil society, Citizens"
        },
        financing: {
            title: "Financing",
            text: "Middle",
        ...
        competences: {
            title: "Competences",
            text: "Architects, building permit, finances, planning and building"
        },
        obstacles: {
            title: "Obstacles",
            text: "Building permit, contract period."
        },
        forward: {
            title: "Ways forward",
            text: "The company is planning the rebuilding of the main entrance."
        },
        impact: {
            title: "Impact",
            text: "We think that the proposal, if implemented successfully, could have a positive societal impact and contribute to the local realization of SDG 3: Good health and well - being, SDG 5: Gender equality, SDG 8: Decent work and economic growth, SDG 12: Responsible consumption and production, and SDG 16: Peace, justice and strong institutions."
        }
